/*
 ...
 Version     :
 Copyright   :
 Description : filter co-efficients for WT
 ============================================================================
 */
...
float sqrt2;
float sqrt3;
static float D2c[2],D2d[2];
static float D4c[4],D4d[4];
static float D6c[6],D6d[6];

static float C6c[6],C6d[6];
static float C12c[12],C12d[12];
static float C18c[18],C18d[18];
 
void initD2(float **c, float **d, int *support)
{
sqrt2 = sqrt(2.);
...
void initD2inv(float **c, float **d, int *support)
{
sqrt2 = sqrt(2.);
sqrt2 =  sqrt2;
...
void initD4(float **c, float **d, int *support)
{
sqrt3 = sqrt(3.);
sqrt2 = 4. * sqrt(2);
...
void initD4inv(float **c, float **d, int *support)
{
sqrt3 = sqrt(3.);
sqrt2 = 4. * sqrt(2);
...
void initD6(float **c, float **d, int * support)
{
sqrt2 = sqrt(2.);
...
void initD6inv(float **c, float **d, int * support)
{
sqrt2 = sqrt(2.);
...
void initC6(float **c, float **d, int *support)
{	
...
void initC6inv(float **c, float **d, int *support)
{
sqrt2 = sqrt(2.);
sqrt2 =  sqrt2;
...
void initC12(float **c, float **d, int *support)
{
sqrt2 = sqrt(2.);
...
void initC12inv(float **c, float **d, int *support)
{
sqrt2 = sqrt(2.);
...
void initC18(float **c, float **d, int *support)
{
sqrt2 = sqrt(2.);
...
void initC18inv(float **c, float **d, int *support)
{
sqrt2 = sqrt(2.);
